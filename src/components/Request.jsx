		...
		<div className={classNames('request', { wrong: !isOk })}>
			<div className="request__content">
				<div
					...
					className="request__indicator"
				></div>

				<div className={classNames('request__copy', { dnone: !copy })}>
					Скопировано
				</div>
				<div
					className="request__action"
					onClick={() => onClickRequestHandler(id)}
				>
					{action}
				</div>
			...
			{isOpenDropdown ? (
				<Fragment>
					<div
						className={classNames('backdrop', { dblock: isOpenDropdown })}
